...
import logo_ from "@/assets/img/logo.svg";
...
const menu_data: DataType[] = [
	{
		...
		link: "/",
		has_dropdown: false,
		// Commenting out dropdown for home pages, keeping only Digital Agency
		/* has_dropdown: true,
		sub_menu: [
			{
				id: 1,
	...
	}, */
	{
		...
		link: "/service",
		has_dropdown: false,
		// Commenting out dropdown, keeping only Services page
		/* has_dropdown: true,
		sub_menu: [
			{
				id: 1,
	...
	},
	{
		...
		link: "/portfolio",
		has_dropdown: false,
		// Commenting out dropdown, keeping only Portfolio page
		/* has_dropdown: true,
		sub_menu: [
			{
				id: 1,
	...
	// Commenting out dropdown, keeping only Blog page
		/* has_dropdown: true,
		sub_menu: [
			{
				id: 1,
...
const HeaderOne = () => {
  ...
  useEffect(() => {
		...
		<>
			...
			<header className={`cs_site_header cs_style1 cs_sticky_header cs_site_header_full_width ${sticky ? 'cs_gescout_sticky' : ''}`}>
				<div className="cs_main_header">
					...
					<div className="cs_main_header_in" style={{ display: 'flex', alignItems: 'center' }}>
    <div className="cs_main_header_left">
        <Link className="cs_site_branding logo-dark" href="/">
            <Image 
                src={logo_} 
                alt="Logo" 
                style={{ display: 'inline-block', height: '100px', width: 'auto', marginRight: '20px' }} 
            />
        </Link>
    ...
    <div className="cs_main_header_right" style={{ display: 'flex', alignItems: 'center' }}>
        <div className="cs_nav cs_medium" style={{ display: 'flex', alignItems: 'center' }}>
            <MobileMenu active={active} navTitle={navTitle} openMobileMenu={openMobileMenu} />
            <span className={`cs_munu_toggle ${active ? "cs_toggle_active" : ""}`} onClick={handleActive}>
                <span></span>
            </span>
        </div>
							...
							<div className="cs_box_two">
								<div>
									<p>
										...
										<span className="ms-2">Bhamasha Techno Hub, Malviya Nagar, <br />
											&nbsp; &nbsp; &nbsp; &nbsp; Jaipur, Rajasthan 302018</span>
									</p>

									<h4 className="cs_phone_number">
										<a href="tel:+917665127830">
											<svg width="35" height="35" viewBox="0 0 18 19" fill="none"
												...
												<path
													...
													fill="white"></path>
											</svg><span className="ms-2">+91 7665127830</span></a>
									</h4>

									<ul className="cs_social_link">
										<li><a target="_blank" href="https://www.facebook.com/">Facebook</a></li>
										<li><a target="_blank" href="https://www.linkedin.com/company/catalyst-canvas/posts/?feedView=all ">Linkedin</a></li>
										<li><a target="_blank" href="https://www.instagram.com/catalystcanvas.co?igsh=MWw3ZTh4eGZvZm8xdw== ">Instagram</a></li>
