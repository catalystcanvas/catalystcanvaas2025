...
const testimonial_data: DataType[] = [
  {
    ...
    name: `10 Exchange`,
    location: ``,
    des: `“The site captures the elegance of our property perfectly. From layout to mobile optimization — every detail was handled with care. A truly polished outcome.”`,
  },
  {
    img: avatar_img,
    name: `BS Associates`,
    location: ``,
    des: `"Working with this team has been a smooth and professional experience. They understood our requirements clearly and delivered a clean, fast, and user-friendly website. We’re happy with the results and highly recommend their services!"`,
  },
  // {
  //   img: avatar_img,
  //   name: `Delores Olivo`,
