...
const ContactArea = () => 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbx1NEVCW2w7yoglu3cZDH0VcjQBmcijX8LSDlJRpeL9SEcFLW4rNg1Nv_zidwUwvexf/exec', {
      method: 'POST',
    ...
    Thank you! We’ll be in touch soon.
      ...
      <div className="row">
        <div className="cs_field_group col">
          Name <input className="cs_input_field" type="text" id="name" placeholder="Name" name="name"  onChange={handleChange} required />
          {/* <label htmlFor="name" className="cs_input_label">Name</label> */}
        </div>
        <div className="cs_field_group col">
          Email<input className="cs_input_field" type="email" id="email" placeholder="Email" name="email"  onChange={handleChange} required />
          {/* <label htmlFor="email" className="cs_input_label">Email</label> */}
        </div>
      </div>
      <div className="row">
        <div className="cs_field_group col">
          Phone <input className="cs_input_field" type="text" id="phone" placeholder="Phone" name="phone"  onChange={handleChange} required />
          {/* <label htmlFor="phone" className="cs_input_label">Phone</label> */}
        </div>
      </div>
      <div className="cs_field_group">
        Message <input className="cs_input_field" type="text" id="message" placeholder="Message" name="message"  onChange={handleChange} required />
        ...
        <span>{loading ? 'Sending...' : 'Send Now'}</span>
            ...
            <div className="cs_contact_section_2 anim_div_ShowRightSide">
              <div className="cs_google_map cs_bg" data-src="assets/img/map_img.png">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.1227315718575!2d75.81574347522276!3d26.867841476673977!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db7b51669dee9%3A0x3708a6ae96453829!2sBhamashah%20Techno%20Hub!5e0!3m2!1sen!2sin!4v1745581628039!5m2!1sen!2sin"
                ...
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">Bhamasha Techno Hub, Malviya Nagar, Jaipur, Rajasthan</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="cs_icon">
                    <a href="tel:+917665127830" className="cs_icon_style">
                      <i>
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">+91 7665127830</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
