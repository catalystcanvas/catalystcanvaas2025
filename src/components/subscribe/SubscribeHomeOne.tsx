...
const SubscribeHomeOne = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
      ...
      fetch('https://script.google.com/macros/s/AKfycbxFzPBB2qk8qJjpPbtg6BNtFVWVcTXtyf4Km7h6M1uMK9y182N46-Ot92U_uGZJMFN3QQ/exec', {
        method: 'POST',
  ...
  <div style={{
    ...
    Thank you! We’ll be in touch soon.
            ...
            >
              {loading ? (
                <div className="cs_loading_spinner"></div>
              ) : (
