    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <aside className={styles.sidebar}>
          <h4 className={styles.sidebarTitle}>PrePaw</h4>
