...
const hero_slider: DataType[] = [
  {
    ...
    des: `At our digital agency, we don’t just build websites—we craft powerful digital experiences designed to grow your business. From sleek, responsive design to data-driven marketing and precision-targeted advertising, we combine creativity with strategy to help you stand out in a crowded online world. Let’s turn your vision into results and create a lasting digital impact`
  },
  // {
