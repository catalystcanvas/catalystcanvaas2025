...
const about_slider: DataType[] = [
  {
    ...
    title: `Catalyzing Creativity Accelerating Brands`,
    des: (
      <>
        At Catalyst Canvas, we help businesses stand out with websites that convert and advertising that connects.
        From scroll-stopping campaigns to smart, beautifully built websites — we blend creativity, strategy, and heart to bring your brand to life.
        <br /><br />
        <strong>More than marketing — we’re your creative growth partner.</strong>
        <br />
        <strong style={{ color: '#FF6600' }}>Your Brand, Our Canvas.</strong>
      </>
    ),
  },
  // {
